...
o3_initial_position = np.array([0., co2_bond_length * 1.25, co2_bond_length * 3])
o3_initial_velocity = np.array([0., 0., 0.])

o4_initial_position = np.array([0., -co2_bond_length * 0.75, co2_bond_length * 3])
o4_initial_velocity = np.array([0., 0., 0.])
